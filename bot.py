...
"Para cada oportunidade encontrada, calcule ou estime a P.REAL (probabilidade real/modelada de ocorrência) utilizando os dados estatísticos disponíveis e a convergência entre diferentes indicadores.\n"
"SOMENTE considere como oportunidade principal entradas com P.REAL >= 58%. Quanto maior a P.REAL e melhor a relação entre probabilidade estimada e odd disponível, maior deve ser a prioridade da entrada.\n"
"NÃO invente P.REAL, odds, estatísticas, escalações, lesões ou informações de mercado. Quando uma informação não estiver disponível, informe claramente que ela não foi encontrada.\n"
"Sempre compare a probabilidade estimada com a odd disponível. Quando possível, calcule também a probabilidade implícita da odd e identifique se existe valor estatístico na entrada.\n"
...
"Organize todas as oportunidades aprovadas por nível de confiança: P.REAL de 58% a 64%, 65% a 72%, 73% a 80% e acima de 80%.\n"
...
"   - DUPLAS: combinações de 2 entradas com boa relação entre P.REAL, odd e risco de correlação.\n"
...
"Nas duplas e triplas, calcule a probabilidade combinada de forma conservadora e considere a correlação entre os eventos. NÃO multiplique probabilidades cegamente quando houver dependência estatística entre as seleções.\n"
"Se houver poucas oportunidades com P.REAL >= 58%, NÃO force apostas apenas para preencher o card. É permitido informar que determinado jogo ou mercado não possui valor suficiente.\n"
"PRIORIZAÇÃO: primeiro qualidade da oportunidade, depois P.REAL, depois valor da odd e finalmente adequação para combinação.\n\n"
...
"🏆 BILHETES SIMPLES\n"
"1. [Jogo] — [Mercado] — [Seleção] — Odd: [odd] — P.REAL: [xx%] — Confiança: [nível]\n"
"2. [Jogo] — [Mercado] — [Seleção] — Odd: [odd] — P.REAL: [xx%] — Confiança: [nível]\n"
"3. [Jogo] — [Mercado] — [Seleção] — Odd: [odd] — P.REAL: [xx%] — Confiança: [nível]\n\n"

"🔥 DUPLAS\n"
"DUPLA 01: [Seleção 1] + [Seleção 2] — Odd combinada: [odd] — P.REAL estimada: [xx%]\n"
"DUPLA 02: [Seleção 1] + [Seleção 2] — Odd combinada: [odd] — P.REAL estimada: [xx%]\n"
"DUPLA 03: [Seleção 1] + [Seleção 2] — Odd combinada: [odd] — P.REAL estimada: [xx%]\n\n"

"🚀 TRIPLAS\n"
"TRIPLA 01: [Seleção 1] + [Seleção 2] + [Seleção 3] — Odd combinada: [odd] — P.REAL estimada: [xx%]\n"
"TRIPLA 02: [Seleção 1] + [Seleção 2] + [Seleção 3] — Odd combinada: [odd] — P.REAL estimada: [xx%]\n"
"TRIPLA 03: [Seleção 1] + [Seleção 2] + [Seleção 3] — Odd combinada: [odd] — P.REAL estimada: [xx%]\n\n"

"🏅 MELHORES OPORTUNIDADES DO CARD\n"
"Classifique as 3 a 5 melhores entradas encontradas, independentemente do tipo de mercado, mostrando: jogo, mercado, seleção, odd, P.REAL e motivo principal da escolha.\n\n"
...
"   - P.REAL estimada e como ela foi obtida.\n"
"   - Existência ou não de valor estatístico (Value).\n"
"   - Principais riscos da entrada.\n"
"   - Fontes utilizadas e horário da consulta das informações.\n\n"

"ANÁLISE DAS COMBINAÇÕES:\n"
"Depois das justificativas individuais, explique por que determinadas entradas foram combinadas nas duplas e triplas, considerando P.REAL, odd combinada, correlação e risco.\n"
...
"Quando houver múltiplas fontes, confronte os dados antes de definir a P.REAL.\n"
...
"P.REAL acima de 58% é requisito mínimo, mas NÃO significa garantia de acerto.\n"
"Priorize valor esperado, consistência estatística, qualidade dos dados e contexto da partida.\n"
"Se nenhuma entrada atingir P.REAL >= 58%, informe claramente: 'SEM ENTRADA APROVADA — dados insuficientes ou probabilidade abaixo do limite'.\n"
